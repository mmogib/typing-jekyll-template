...
;(function(window, document, undefined){
  ...
  var options = {
    ...
    json: [],
    jsonFormat: 'title,tags,category,url,date',
    // Line below changed by William Canin
...
SimpleJekyllSearch({
  ...
  noResultsText:'<p class="layout-search__data__not-search">{{ loadData.website.search.input.notfound }}</p>',
  limit:10,
  fuzzy:!1
});
